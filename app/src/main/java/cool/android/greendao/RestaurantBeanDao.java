...
/** 
 * DAO for table "RESTAURANT_BEAN".
*/
public class RestaurantBeanDao extends AbstractDao<RestaurantBean, Long> {

    public static final String TABLENAME = "RESTAURANT_BEAN";

    /**
     * Properties of entity RestaurantBean.<br/>
    ...
    public RestaurantBeanDao(DaoConfig config) {
        super(config);
    }
    
    public RestaurantBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RESTAURANT_BEAN\"";
        db.execSQL(sql);
    }
